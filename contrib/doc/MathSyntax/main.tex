...
{\begin{table}\def\capentries{#1}\def\labelentries{#2}%
\setcounter{entryi}{1}\begin{tabular}{|llll|}\hline  & Expression & Meaning & Syntax \\ \hline}%
{\hline\end{tabular}\caption{\capentries}\label{\labelentries}\end{table}}%

\newcommand\entry[4]{{\theentryi\labelentry}\stepcounter{entryi} & #1 & #2 & #3 \\[1mm] & \textbf{Discussion:}& \multicolumn{2}{l|}{#4} \\[3mm]}
